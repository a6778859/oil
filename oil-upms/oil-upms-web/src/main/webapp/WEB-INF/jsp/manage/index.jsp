...
<head>
	...
	<link href="${basePath}/resources/oil-admin/plugins/bootstrap-3.3.0/css/bootstrap.min.css" rel="stylesheet"/>
	<link href="${basePath}/resources/oil-admin/plugins/material-design-iconic-font-2.2.0/css/material-design-iconic-font.min.css" rel="stylesheet"/>
	<link href="${basePath}/resources/oil-admin/plugins/waves-0.7.5/waves.min.css" rel="stylesheet"/>
	<link href="${basePath}/resources/oil-admin/plugins/malihu-custom-scrollbar-plugin/jquery.mCustomScrollbar.min.css" rel="stylesheet"/>
	<link href="${basePath}/resources/oil-admin/css/admin.css" rel="stylesheet"/>
	<style>
		/** skins **/
...
<script src="${basePath}/resources/oil-admin/plugins/jquery.1.12.4.min.js"></script>
<script src="${basePath}/resources/oil-admin/plugins/bootstrap-3.3.0/js/bootstrap.min.js"></script>
<script src="${basePath}/resources/oil-admin/plugins/waves-0.7.5/waves.min.js"></script>
<script src="${basePath}/resources/oil-admin/plugins/malihu-custom-scrollbar-plugin/jquery.mCustomScrollbar.concat.min.js"></script>
<script src="${basePath}/resources/oil-admin/plugins/BootstrapMenu.min.js"></script>
<script src="${basePath}/resources/oil-admin/plugins/device.min.js"></script>
<script src="${basePath}/resources/oil-admin/plugins/jquery.cookie.js"></script>
<script src="${basePath}/resources/oil-admin/js/admin.js"></script>
<script src="${basePath}/resources/oil-admin/plugins/fullPage/jquery.fullPage.min.js"></script>
<script src="${basePath}/resources/oil-admin/plugins/fullPage/jquery.jdirk.min.js"></script>
</body>
</html>